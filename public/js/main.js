...
/* JS Modal used in clientFixedPricedInvoiceList.html */
...
Invoice.prototype = {
  ...
  init: function () {
      ...
      this.calcTotalQty();
      this.calcSubtotal();
      this.calcTax_deduction();
      this.calcSubtotal_aftertax();
      this.calcGrandTotal();
  },
  ...
  calcSubtotal: function () {
   ...
   /**
   * Calculate tax deductions of an order.
   *
   * @returns {number}
   */
   
   calcTax_deduction: function () {

    var tax_deduction = (Number(jQuery($.opt.subtotal).val()) * Number(jQuery($.opt.tax).val()))/100
                   
    tax_deduction = self.roundNumber(tax_deduction, 2);

    jQuery($.opt.tax_deduction).val(tax_deduction);
   ...
   /**
   * Calculate subtotal after tax deductions of an order.
   *
   * @returns {number}
   */

   calcSubtotal_aftertax: function () {

    var subtotal_aftertax = 0;

    subtotal_aftertax =  (Number(jQuery($.opt.subtotal).val()) + Number(jQuery($.opt.tax_deduction).val()));
    
    jQuery($.opt.subtotal_aftertax).val(subtotal_aftertax);
  ...
  calcGrandTotal: function () {
    ...
    var grandTotal = Number(jQuery($.opt.subtotal_aftertax).val())
...
jQuery.fn.invoice.defaults = {
  ...
  subtotal_aftertax : "#subtotal_aftertax",
  discount: "#discount",
  shipping : "#shipping",
